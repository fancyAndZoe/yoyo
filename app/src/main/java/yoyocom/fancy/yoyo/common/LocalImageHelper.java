...
public class LocalImageHelper {
    ...
    private final YoyoApplication context;
    ...
    public String setCameraImgPath() {
        String foloder= YoyoApplication.getInstance().getCachePath()
                + "/PostPicture/";
    ...
    private LocalImageHelper(YoyoApplication context) {
    ...
    public static void init(YoyoApplication context) {
    ...
    public synchronized void initImage() {
        ...
        while (cursor.moveToNext()) {
            ...
            if (file.exists()) {
                ...
                if(yoyocom.fancy.yoyo.common.StringUtils.isEmpty(uri))
                    continue;
